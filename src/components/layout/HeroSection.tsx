...
const heroContent = [
    ...
    {
        type: 'video',
        desktop: '/images/combos/combo_1/PROMO _DESKTOP.mp4',
        mobile: '/images/combos/combo_1/PROMO_MOBILE.mp4',
    ...
    {
        type: 'video',
        desktop: '/images/combos/combo_1/SEGURIDAD_DEKSTOP.mp4',
        mobile: '/images/combos/combo_1/SEGURIDA_MOBILE.mp4',
